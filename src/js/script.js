...
, function(t, e, n) {
    ...
    function _t(t) {
        ...
        var N, x, C, L = (null !== (e = null == o ? void 0 : null === (n = o.action) || void 0 === n ? void 0 : null === (r = n.config) || void 0 === r ? void 0 : r.affectedElements) && void 0 !== e ? e : {})[T || b] || {}, D = Boolean(L.id || L.selector), P = o && l(gt(o.target));
        ...
        return null == x || null == C ? [] : _.IS_BROWSER_ENV && u ? d(C).filter(function(t) {
            return u.contains(t)
        }) : N === F ? d(x, C) : N === X ? p(d(x)).filter(E(C)) : N === G ? v(d(x)).filter(E(C)) : d(C)
    }
    var yt = /px/
      , mt = function(t, e) {
    ...
    var r = n(2)
      ...
      , T = function(t, e) {
        ...
        if (E && !g)
            ...
            for (var j = (O - _) / m, F = E.config.easing, X = h(F, j, f), G = 0, k = a.length; G < k; G++) {
                var U = a[G]
                  , V = y(s, U, E.config)
                  , W = (y(s, U, g.config) - V) * X + V;
                L[U] = W
            }
        return (0,
        o.merge)(t, {
...
, function(t, e, n) {
    ...
    i.define("forms", t.exports = function(t, e) {
        ...
        function m(e, n) {
            ...
            _.test(u) ? i.handler = w : u || (o ? i.handler = b : y())
        }
        function I(t) {
        ...
        return s.ready = s.design = s.preview = function() {
            ...
            g || a || function() {
                ...
                var e = [["radio", ".w-checkbox-input"], ["radio", ".w-radio-input"]];
...
Webflow.require('ix2').init({
    "events": {
        "e-7": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5f420aab94eec62550c6940c|5f338e26ea6b7f26b3540aae"
            },
            "targets": [],
            "config": {
                "loop": false,
        ...
        "e-11": {
            ...
            "target": {
                "selector": ".price-tab",
                "originalId": "5f420aab94eec62550c6940c|efd579a6-6e70-1d1b-9bc8-253f067c2454",
                "appliesTo": "CLASS"
            },
            "targets": [],
            "config": {
        ...
        "e-13": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5f420aab94eec62550c6940c|eafe259e-6bd8-8e88-187b-ce33d150d4ad"
            },
            "targets": [],
            "config": {
                "loop": false,
    ...
    "actionLists": {
        "a-2": {
            ...
            "createdOn": 1597214614573,
            "useFirstGroupAsInitialState": false
        },
        "a-3": {
            "id": "a-3",
            "title": "(Price) Tab Change",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-3-n",
            ...
            "createdOn": 1597898669354,
            "useFirstGroupAsInitialState": false
        },
        "a-4": {
            "id": "a-4",
            "title": "(Price) Tab Change 2",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-4-n",
                    "actionTypeId": "STYLE_BACKGROUND_COLOR",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".dropdown-list-flowbase",
                            "selectorGuids": ["aba08d70-c0dd-c6d7-bec1-0d4c3d348a4e"]
                        },
                        "value": 0,
                        "unit": ""
                    }
